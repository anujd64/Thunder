...
//
//@AndroidEntryPoint
//public class AddNewIndexFragmentHilt extends BaseFragment {
//
//    SendPostRequest sendPostRequest;
//    @Inject
//    public AddNewIndexFragment(SendPostRequest sendPostRequest){
...
//                                    makeAPICall(folderType, indexType, link, user, pass, false, index_id);
//                                }
//
//                                if(folderType.equals("TVShows")){
//                                    makeAPICall(folderType, indexType, link, user, pass, true, index_id);
//                                }
//
//
//
...
////                                    }
////                                    if (indexType.equals("TGIndex")) {
////                                        getRequestTgIndex(link, user, pass, false, index_id);
////                                    }
////                                }
////
////                                if (folderType.equals("TVShows")) {
...
////                                    }
////                                    if (indexType.equals("TGIndex")) {
////                                        getRequestTgIndex(link, user, pass, true, index_id);
////                                    }
////                                }
//                                mActivity.runOnUiThread(new Runnable() {
//                                    @Override
...
//
//
//    private void makeAPICall(String folderType, String indexType, String link, String user, String pass, boolean isTVShow, int index_id) {
//        if (indexType.equals("GDIndex")) {
//            sendPostRequest.postRequestGDIndex(link, user, pass, isTVShow, index_id);
//        } else if (indexType.equals("GoIndex")) {
//            sendPostRequest.postRequestGoIndex(link, user, pass, isTVShow, index_id);
//        } else if (indexType.equals("Maple")) {
//            sendPostRequest.postRequestMapleIndex(link, user, pass, isTVShow, index_id);
//        } else if (indexType.equals("SimpleProgram")) {
//            sendPostRequest.postRequestSimpleProgramIndex(link, user, pass, isTVShow, index_id);
//        } else if (indexType.equals("TGIndex")) {
//            sendPostRequest.getRequestTgIndex(link, user, pass, isTVShow, index_id);
//        }
//    }
//}
//
